...
```pwsh
pip install git+https://github.com/korarei/AviUtl2_Astra.git@v0.5.2
```
...
```pwsh
uv tool install git+https://github.com/korarei/AviUtl2_Astra.git@v0.5.2
