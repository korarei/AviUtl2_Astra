...
AviUtl ExEdit2の拡張機能開発支援およびパッケージ (au2pkg) 作成ツール．
...
```pwsh
pip install git+https://github.com/korarei/AviUtl2_Astra.git@v0.6.1
```
...
```pwsh
uv tool install git+https://github.com/korarei/AviUtl2_Astra.git@v0.6.1
...
指定したバージョンのAviUtl ExEdit2のポータブル版をダウンロードし，仮想環境を構築する．
