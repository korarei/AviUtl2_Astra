...
```pwsh
pip install git+https://github.com/korarei/AviUtl2_Astra.git@v0.6.0
```
...
```pwsh
uv tool install git+https://github.com/korarei/AviUtl2_Astra.git@v0.6.0
